...
export default function FleurirQuizClient({ quizData, topicTitle, onComplete }) {
  ...
  function handleSubmit() {
    ...
    // Trigger companion animation
    setCompanionAnim(correct ? "encourage" : "idle");
    setTimeout(() => setCompanionAnim("idle"), 800);
  }
  ...
  if (finished) {
    ...
    // Trigger celebration animation on result screen
    useEffect(() => {
      setCompanionAnim("celebrate");
      setTimeout(() => setCompanionAnim("idle"), 2000);
    }, []);
    ...
    return (
      <>
        ...
        <div className="quiz-page">
          ...
          {/* Companion in corner on result screen */}
          <div style={Q.companionCorner}>
            <CompanionDisplay 
  ...
  return (
    <>
      ...
      <div className="quiz-page">
        ...
        {/* Companion in bottom-left corner */}
        <div style={Q.companionCorner}>
          <CompanionDisplay 
            companionId={companionId} 
            variant="corner" 
        ...
        <div className="quiz-card">
          <p style={Q.prompt}><MathText text={q.prompt} /></p>
          ...
          {answered && (
            <div className="fade-slide-up" style={{
              ...
              {isCorrect() ? "✓ Correct! Well done, Scholar." : <span>✗ Not quite. The answer is: <MathText text={q.correctAnswer.value.toString()} /></span>}
            </div>
          )}
