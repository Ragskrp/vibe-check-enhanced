...
import { Flame, Trophy, Landmark, ArrowRight } from 'lucide-react';
...
export default function BusinessClientWrapper() {
  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <section style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 clamp(20px,5vw,100px)', maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ opacity: mounted ? 1 : 0, transform: mounted ? 'none' : 'translateY(30px)', transition: 'all 0.8s cubic-bezier(0.16, 1, 0.3, 1)' }}>
            ...
            <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.3em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', fontFamily: 'Inter,sans-serif', marginBottom: 16 }}>
              AQA · GCSE Business Revision Games
            </div>
            <h1 style={{ fontSize: 'clamp(48px,9vw,110px)', fontWeight: 200, lineHeight: 1.0, letterSpacing: '-0.04em', color: '#fff', marginBottom: 24 }}>
              Strategic<br />
              <span style={{ fontWeight: 800, background: `linear-gradient(135deg,#fff 30%,${COLOR} 100%)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Business Games.</span>
            </h1>
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: 18, color: 'rgba(255,255,255,0.45)', maxWidth: 540, lineHeight: 1.8, marginBottom: 48, fontWeight: 300 }}>
              Master the mechanics of the market through interactive play. From venture capital games to corporate operations—exam-aligned GCSE business revision.
            </p>
        ...
        <section id="topics" style={{ maxWidth: 1200, margin: '0 auto', padding: '80px clamp(20px,5vw,100px) 100px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 48 }}>
            <Landmark size={18} color="rgba(255,255,255,0.3)" />
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.25em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', fontFamily: 'Inter,sans-serif' }}>Business Game Domains</div>
          </div>
            ...
            return (
              <div key={cat} style={{ marginBottom: 80 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: 16 }}>
                  ...
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.2)', fontFamily: 'Inter,sans-serif', fontWeight: 600 }}>{topics.length} Games</div>
                </div>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(20px,5vw,100px) 100px' }}>
          ...
          <div style={{ marginTop: 80 }}>
            <PageValueSection
              title="The Value of GCSE Business Games"
              summary="Business success is built on understanding relationships. Our interactive GCSE business games help you master Break-even, Margin of Safety, and market logic."
              points={[
                { label: 'Interactive Business Logic', text: 'Mastering formulas for Break-even and Gross Profit through gamified practice modules.' },
                { label: 'Strategic Application', text: 'Learn how specific business decisions impact stakeholders through interactive case study games.' },
                { label: 'Market Intuition', text: 'Our tools build the commercial intuition needed for high-tier paper 2 analysis.' },
              ]}
              checklist={['Recall the 4 Ps of Marketing through our interactive modules.', 'Play the Profit Margin game and master the formulas.', 'Explore the differences between Internal and External growth via active recall.']}
            />
          </div>
        </div>
      </div>
