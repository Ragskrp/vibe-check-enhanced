...
import { Flame, Trophy, Book, Languages, ArrowRight } from 'lucide-react';
...
export default function EnglishLanguageClientWrapper() {
  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <section style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 clamp(20px,5vw,100px)', maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ opacity: mounted ? 1 : 0, transform: mounted ? 'none' : 'translateY(30px)', transition: 'all 0.8s cubic-bezier(0.16, 1, 0.3, 1)' }}>
            ...
            <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.3em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', fontFamily: 'Inter,sans-serif', marginBottom: 16 }}>
              AQA · GCSE English Language Games
            </div>
            <h1 style={{ fontSize: 'clamp(48px,9vw,110px)', fontWeight: 200, lineHeight: 1.0, letterSpacing: '-0.04em', color: '#fff', marginBottom: 24 }}>
              Linguistic<br />
              <span style={{ fontWeight: 800, background: `linear-gradient(135deg,#fff 30%,${COLOR} 100%)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Dexterity Games.</span>
            </h1>
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: 18, color: 'rgba(255,255,255,0.45)', maxWidth: 540, lineHeight: 1.8, marginBottom: 48, fontWeight: 300 }}>
              Command the language through play. From surgical reading analysis to evocative creative writing—interactive GCSE English Language games for precision practice.
            </p>
        ...
        <section id="topics" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(20px,5vw,100px) 100px' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(20px,5vw,100px) 100px' }}>
          ...
          <div style={{ marginTop: 80 }}>
            <PageValueSection
              title="The Value of GCSE English Language Games"
              summary="English Language is a performance. Our interactive games help you deconstruct complex texts and secure technical marks through play."
              points={[
                { label: 'Analytical Speed Games', text: 'Practicing AO1–AO4 retrieval tasks through interactive modules builds the mental speed needed for unseen texts.' },
                { label: 'Technical Accuracy Practice', text: 'Our games emphasize varied punctuation and sophisticated vocabulary for those crucial AO6 marks.' },
                { label: 'Structural Logic', text: 'Learn to see the architecture of a text through interactive structural analysis games.' },
              ]}
              checklist={['Practice "Word-Level Zoom" analysis through our interactive tools.', 'Master the 10 sophisticated punctuation marks via active recall games.', 'Identify command words in our simulated exam scenarios.']}
            />
          </div>
        </div>
      </div>
